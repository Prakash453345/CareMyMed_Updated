 ...
 */
exports.getMentorPatients = async (req, res) => {
  try {
    const mentorId = req.params.id;
 ...
 */
exports.updateMentorPatientPermissions = async (req, res) => {
  try {
 ...
 */
exports.checkMentorPatientPermission = async (req, res) => {
  try {
    const { id: mentorId, patientId } = req.params;
 ...
 */
exports.logMentorPatientAccess = async (req, res) => {
  try {
    const { id: mentorId, patientId } = req.params;

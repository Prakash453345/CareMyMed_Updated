...
router.put(
  '/me/conditions',
  authenticateSession,
  updateProfileArray('conditions')
);
router.put(
  '/me/allergies',
  authenticateSession,
  updateProfileArray('allergies')
);
router.put(
  '/me/vaccinations',
  authenticateSession,
  updateProfileArray('vaccinations')
);
router.put(
  '/me/appointments',
  authenticateSession,
  updateProfileArray('appointments')
);
router.put(
  '/me/medical-history',
  authenticateSession,
  updateProfileArray('medical_history')
);
...
router.delete(
  ...
  authenticateSession,
  validateObjectId('id'),
  deleteProfileItem('conditions', 'conditions')
);
router.delete(
  '/me/allergies/:id',
  authenticateSession,
  validateObjectId('id'),
  deleteProfileItem('allergies', 'allergies')
);
router.delete(
  '/me/vaccinations/:id',
  authenticateSession,
  validateObjectId('id'),
  deleteProfileItem('vaccinations', 'vaccinations')
);
router.delete(
  '/me/appointments/:id',
  authenticateSession,
  validateObjectId('id'),
  deleteProfileItem('appointments', 'appointments')
);
router.delete(
  '/me/medical-history/:id',
  authenticateSession,
  validateObjectId('id'),
  deleteProfileItem('medical_history', 'medical_history')
);
router.delete(
  '/me/history/:id',
  authenticateSession,
...
router.delete(
  ...
  authenticateSession,
  validateObjectId('id'),
  deleteProfileItem('medications', 'medications')
);
router.delete(
  '/me/trusted-contacts/:id',
  authenticateSession,
  validateObjectId('id'),
  deleteProfileItem('trusted_contacts', 'trusted_contacts')
);
router.delete(
  '/me/contact/:id',
  authenticateSession,
